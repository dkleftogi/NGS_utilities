...
def printUsage():
    ...
    print('\tpython findGermline.py vcfFile=file.vep.vcf normal=NormalName\n')
    print('Where:\n') 
    print('\tfile.vep.vcf is VCF file annotated by VEP. Preferably in VCFv4.0 format as generated by the Platypus variant caller\n')
    print('\tNormalName is the name for the normal sample. It has to be the same as in the header of the original VCF')
